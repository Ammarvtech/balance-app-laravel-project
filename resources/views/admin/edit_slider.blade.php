    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                ...
                <br/>
                <form method="post" name="frm" action="{{url('edit-slider/'.$id)}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="tab-content">
                        @foreach ($sliders as $key => $v)
                            ...
                            <!--<div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Button Text<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text"  name="button_text[]" class="form-control col-md-7 col-xs-12" value="{{$v->button_text}}" >
                                </div>
                            </div>-->
                           
                            @if($key == 0)
                                <div class="item form-group">
                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Background Image</label>
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <img width="100px" height="100px" src="{{ asset('/images/slider/'.$v->image) }}">
                                    </div>
                                </div>
                                @endif
                                <div class="item form-group">
                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Baner</label>
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="file" id="baner" name="baner" class="form-control col-md-7 col-xs-12" value="" />
                                    </div>
                                </div>
                                @if(isset($v->baner) && ($v->baner) !="")
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">&nbsp;</label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <img width="100px" height="100px" src="{{ asset('/images/slider/'.$v->baner) }}">
                                    </div>
                                </div>
                                @endif
                                    <div class="item form-group">
