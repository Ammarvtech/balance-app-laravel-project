    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                ...
                <br/>
                <form method="post" name="frm" action="{{url('edit-page/'.$id)}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="tab-content">
                        @foreach ($pages as $key => $v)
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea name="body[]" class="ckeditor form-control col-md-7 col-xs-12">{{$v->body}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <img width="100px" height="100px" src="{{ asset('/images/sections/'.$v->image) }}">
                                </div>
                            </div>
                            @endif
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Type <span class="required">*</span>
                                    </label>
                                       <div class="col-md-7 col-sm-7 col-xs-12">
