    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                ...
                <br/>
                <form method="post" name="frm" action="{{url('edit-faq/'.$id)}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                    @csrf
                    @if($errors->any())
                        ...
                        @foreach ($faq as $key => $v)
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="tetx"  name="question[]" class="form-control col-md-7 col-xs-12" value="{{$v->question}}">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea name="answer[]" class="ckeditor form-control col-md-7 col-xs-12">{{$v->answer}}</textarea>
                                </div>
                            </div>
                            @if($key == 0)
                                <div class="item form-group">
