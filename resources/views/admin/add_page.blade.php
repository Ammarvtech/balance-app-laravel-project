    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                ...
                <br/>
                <form method="post" name="frm" action="{{url('create-page')}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="tab-content">
                        @foreach ($languages as $key => $v)
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea name="body[]" class="ckeditor form-control col-md-7 col-xs-12">{{ old('body.'.$key) }}</textarea>
                                </div>
                            </div>
                            @if($key == 0)
                                ...
                                <div class="item form-group">
                                    ...
                                    <select name="type" id="type" class="form-control" required="required">
                                        <option value="">Select Category</option>
                                            ...
                                            <option value="policy">Privacy</option>
                                    </select>
                                </div>
                                </div>
                            @endif
