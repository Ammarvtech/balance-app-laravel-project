    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                ...
                <br/>
                <form method="post" name="frm" action="{{url('create-feature')}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                    @csrf
                    @if($errors->any())
                    ...
                    @endif -->
                  <!--   @if($errors->any() && old('show_error1') == 1)
                       <div class="alert alert-danger">
                         @foreach($errors->all() as $error)
                           {{ $error }} <br>
                         @endforeach
                        ...
                        @foreach ($languages as $key => $v)
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text"name="title[]" class="form-control col-md-7 col-xs-12" value="{{ old('title.'.$key) }}"  required>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea name="description[]" class="ckeditor form-control col-md-7 col-xs-12" required>{{ old('description.'.$key) }}</textarea>
                                </div>
                            </div>
                            @if($key == 0)
                              <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        <input type="text" id="sort_order" name="sort_order" class="form-control col-md-7 col-xs-12" value="{{old('sort_order')}}" required />
                                    </div>
                                </div>
                            @endif
                            </div>
