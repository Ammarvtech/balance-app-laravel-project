...
<div role="main">
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                <form method="post" name="frm" action="{{url('create-portfolio')}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                 {{ csrf_field() }}
                    @if($errors->any())
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="text" id="seo" name="seo" class="form-control col-md-7 col-xs-12" value="{{ old('seo') }}" />
                        </div>
                    </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <textarea name="body" class="ckeditor form-control col-md-7 col-xs-12" name="wysiwyg-editor">{{ old('body') }}</textarea>
                        </div>
                    </div>
