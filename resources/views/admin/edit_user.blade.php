...
@section('content')
    <div role="main">
      <div class="x_content content">
        ...
        <div class="x_content">
          <div class="x_panel">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('update-user') }}" name="frm" id="frm" novalidate="novalidate"> {{ csrf_field() }}
              @if($errors->any())
              ...
              <div class="item form-group">
                  ...
                  <div class="col-md-7 col-sm-7 col-xs-12">
                      <input type="text" name="email" required="required"  class="form-control col-md-7 col-xs-12" value="{{ $details->email }}" />
                  </div>
              </div>
              <div class="item form-group">
