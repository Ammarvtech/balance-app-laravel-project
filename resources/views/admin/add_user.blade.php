...
@section('content')
    <div role="main">
      <div class="x_content content">
        ...
        <div class="x_content">
          <div class="x_panel">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('saveuser') }}" name="frm" id="frm" novalidate="novalidate"> {{ csrf_field() }}
              @if($errors->any())
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6">
                <input type="text" class="form-control" placeholder="Entity Name" id="name" name="name" value="{{ old('name') }}">
                </div>
              </div>
