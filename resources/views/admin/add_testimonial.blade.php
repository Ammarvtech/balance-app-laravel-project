    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                ...
                <br/>
                <form method="post" name="frm" action="{{url('create-testimonial')}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                    @csrf
                    @if($errors->any())
                        ...
                        @foreach ($languages as $key => $v)
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text"  name="testimonial_name[]" class="form-control col-md-7 col-xs-12" value="{{ old('testimonial_name.'.$key) }}" >
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text"  name="designation[]" class="form-control col-md-7 col-xs-12" value="{{ old('designation.'.$key) }}" >
                                </div>
                            </div>
                            <div class="item form-group">
