    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            ...
            <div class="x_panel">
                ...
                <form method="post" name="frm" action="{{url('edit-category/'.$id)}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                        ...
                        @foreach ($categories as $key => $v)
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    ...
                                    <textarea name="title[]" class="form-control col-md-7 col-xs-12">{{$v->title}}</textarea>
                            ...
                            @if($key == 0)
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                        ...
                                        <input type="file" id="icon" name="icon" class="form-control col-md-7 col-xs-12" value="" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        ...
                                        <img width="100px" height="100px" src="{{ asset('/images/categories/'.$v->icon) }}">
