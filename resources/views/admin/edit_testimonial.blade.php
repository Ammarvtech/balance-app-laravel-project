    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                ...
                <br/>
                <form method="post" name="frm" action="{{url('edit-testimonial/'.$id)}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="tab-content">
                        @foreach ($testimonials as $key => $v)

                            <div id="{{$v->name}}" class="tab-pane fade  @if($key==0) in active @endif">
                                <input name="language_id[]" type="hidden" value="{{$v->language_id}}">
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Name<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text"  name="testimonial_name[]" class="form-control col-md-7 col-xs-12" value="{{$v->testimonial_name}}" >
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Designation<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text"  name="designation[]" class="form-control col-md-7 col-xs-12" value="{{$v->designation}}">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            @if($key == 0)
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Profile</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <img width="100px" height="100px" src="{{ asset('/images/testimonials/'.$v->image) }}">
                                </div>
                            </div>
                            @endif
                                <div class="item form-group">
