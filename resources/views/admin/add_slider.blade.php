    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                ...
                <br/>
                <form method="post" name="frm" action="{{url('create-slider')}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="tab-content">
                        @foreach ($languages as $key => $v)
                            ...
                            <!--<div class="item form-group">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text"  name="button_text[]" class="form-control col-md-7 col-xs-12" value="{{ old('button_text'.$key) }}" >
                                </div>
                            </div>-->
                           
                            @if($key == 0)
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Bakgroud Image</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="file" name="image" class="form-control col-md-7 col-xs-12" value="" />
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Banner</label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="file" name="baner" class="form-control col-md-7 col-xs-12" value="" />
                                </div>
                            </div>
                                <div class="item form-group">
