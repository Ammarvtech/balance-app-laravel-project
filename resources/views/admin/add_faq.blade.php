    ...
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                ...
                <br/>
                <form method="post" name="frm" action="{{url('create-faq')}}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="tab-content">
                        @foreach ($languages as $key => $v)
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Question<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <input type="text"  name="question[]" class="form-control col-md-7 col-xs-12" value="{{ old('question.'.$key) }}" >
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Answer<span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <textarea name="answer[]" class="ckeditor form-control col-md-7 col-xs-12">{{ old('answer.'.$key) }}</textarea>
                                </div>
                            </div>
                            @if($key == 0)
                                <div class="item form-group">
